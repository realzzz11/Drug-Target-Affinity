...
# Hyper-parameter
args.add_argument('-lr', type=float, default=0.0006391476561795109, help='init learning rate')
args.add_argument('-step_size', type=int, default=9, help='step size of lr_scheduler')
args.add_argument('-gamma', type=float, default=0.25250372675914745, help='lr weight decay rate')
args.add_argument('-batch_size', type=int, default=52, help='batch size')
args.add_argument('-num_epochs', type=int, default=80, help='number of epochs')

# graph attention layer
args.add_argument('-gat_dim', type=int, default=36, help='dimension of node feature in graph attention layer')
args.add_argument('-num_head', type=int, default=5, help='number of graph attention layer head')
args.add_argument('-dropout', type=float, default=0.5993944940466771)
args.add_argument('-alpha', type=float, default=0.03348553129590619, help='LeakyReLU alpha')

args.add_argument('-comp_dim', type=int, default=112, help='dimension of compound atoms feature')
args.add_argument('-prot_dim', type=int, default=102, help='dimension of protein amino feature')
args.add_argument('-latent_dim', type=int, default=116, help='dimension of compound and protein feature')
...
args.add_argument('-layer_out', type=int, default=2, help='number of output layer in prediction model')

params, _ = args.parse_known_args()


def train_eval(model, task, data_train, data_test, device, params):
    writer = SummaryWriter(log_dir='optuna_runs/experiment_best_params')
    if task == 'affinity':
